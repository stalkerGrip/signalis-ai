...
### Result 4 — `docs/runtime/runtime_chains/vendor_purchase_item_metadata_sync.md`
...
### Result 5 — `docs/runtime/runtime_chains/vendor_purchase_chain.md`
...
### Result 10 — `docs/runtime/runtime_chains/vendor_purchase_item_metadata_sync.md`
...
### Result 6 — `docs/human_context.md`
...
### Result 7 — `subsystem_docs/runtime_doctrine.md`
...
### Result 8 — `docs/ai_subsystems/inventory.md`
...
### Result 9 — `docs/subsystems/inventory.md`
