...
- Rerank bonus: `0.61`
- Rerank reasons: `['doc_type:runtime_node:+0.00', 'node_type:plugin:+0.12', 'intent_node_type:+0.08', 'plugin_match:inventory:+0.16', 'text_subsystem:character:+0.04', 'text_event:characterpresave:+0.08', 'network_text_match:+0.08', 'high_priority_subsystem:+0.05']`
...
- Rerank bonus: `0.5`
- Rerank reasons: `['doc_type:file_topology:+0.12', 'node_type:file:+0.10', 'intent_node_type:+0.08', 'text_subsystem:character:+0.04', 'text_event:characterpresave:+0.08', 'network_text_match:+0.08']`
...
- Rerank bonus: `0.34`
- Rerank reasons: `['doc_type:runtime_node:+0.00', 'node_type:hook_event:+0.14', 'intent_node_type:+0.08', 'text_subsystem:character:+0.04', 'text_event:characterloaded:+0.08']`
...
## Subsystem / Plugin Hubs

### 1. Runtime topology node: inventory
...
### 1. Runtime topology file summary: plugins/inventory/sh_plugin.lua
...
### 2. Runtime topology file summary: gamemode/core/meta/sh_character.lua
...
### 3. Runtime topology file summary: gamemode/core/meta/inventory/sv_base_inventory.lua
...
### 4. Runtime topology file summary: gamemode/core/meta/inventory/cl_base_inventory.lua
...
### 5. Runtime topology file summary: plugins/inventory/cl_hooks.lua
...
### 6. Runtime topology file summary: gamemode/core/libs/sh_character.lua
...
### 7. Runtime topology file summary: plugins/newvendorsystem/sh_plugin.lua
...
### 8. Runtime topology node: plugins\inventory\sv_hooks.lua
...
### 1. Runtime topology node: inventorySetPanelStatus
...
### 2. Runtime topology node: netstream hook inventorySetPanelStatus
...
## Lifecycle / Hook Signals

### 1. Runtime topology node: PlayerLoadedChar
...
### 2. Runtime topology node: emit CharacterLoaded @ plugins\multichar\sh_plugin.lua:41
...
### 3. Runtime topology node: emit CharacterPreSave @ gamemode\core\meta\sh_character.lua:42
...
### 4. Runtime topology node: emit CharacterLoaded @ gamemode\core\meta\sh_character.lua:129
...
### 5. Runtime topology node: CharacterLoaded
...
### 6. Runtime topology node: CharacterPreSave
...
### 7. Runtime topology node: PlayerLoadout
...
### 8. Runtime topology node: PostPlayerLoadout
