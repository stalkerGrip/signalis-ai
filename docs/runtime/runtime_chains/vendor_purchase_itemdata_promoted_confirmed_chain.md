...
- Candidate artifact: `E:\signalis_ai\investigations\validation\vendor_purchase_itemdata_runtime_chain_candidate_v7.json`
- Promotion validation artifact: `E:\signalis_ai\investigations\validation\vendor_purchase_itemdata_promotion_validation_v7.json`
...
- `E:\signalis_ai\docs\runtime\runtime_chains\vendor_purchase_itemdata_promoted_confirmed_chain.md` → `E:\signalis_ai\docs\runtime\runtime_chains\_superseded\vendor_purchase_itemdata_promoted_confirmed_chain_superseded_20260602_002359.md`
...
```json
{
  ...
  "inputs": [
    "E:\\signalis_ai\\investigations\\validation\\vendor_purchase_itemdata_runtime_chain_candidate_v7.json",
    "E:\\signalis_ai\\investigations\\validation\\vendor_purchase_itemdata_promotion_validation_v7.json"
  ]
}
```
